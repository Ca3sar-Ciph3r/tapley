...
// components/card/card-actions.tsx
//
...
export function CardActions({
  ...
  const ctaTextColor = isDark ? '#111827' : '#ffffff'
    ...
    <div className="flex flex-col gap-3 px-6 pb-10">
      ...
      {waUrl && (
        <a
          ...
          className="flex items-center justify-center gap-2.5 rounded-full py-4 text-base font-semibold transition-opacity active:opacity-75"
      ...
      {/* Custom CTA — only if configured on staff card or company */}
